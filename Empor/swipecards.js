...
const Persons = [
  {name: 't-shirt', image: 'https://images.urbanoutfitters.com/is/image/UrbanOutfitters/41221466_001_b?$xlarge$&defaultImage='},
  {name: 'pants', image: 'https://images.urbanoutfitters.com/is/image/UrbanOutfitters/35866508_001_g?$xlarge$&defaultImage='},
  {name: 'skirt', image: 'https://images.urbanoutfitters.com/is/image/UrbanOutfitters/41442302_085_d?$xlarge$&defaultImage='},
  {name: 'earings', image: 'https://images.urbanoutfitters.com/is/image/UrbanOutfitters/33357088_070_b?$detailMain$'},
  {name: 'zacharyhorvitz', image: 'https://avatars1.githubusercontent.com/u/1000692?v=3&s=400'}
]
          ...
          <Animated.View style={[styles.card, this.props.animatedCardStyles]} {...this.props.panResponder}>
            <Image source={{uri: this.props.image}} style={styles.cardImage}>
              <Animated.View style={[styles.cardImageTextContainer, styles.cardImageYupContainer, this.props.animatedYupStyles]}>
                <Text style={[styles.cardImageText, styles.cardImageYupText]}>pin</Text>
              </Animated.View>
              <Animated.View style={[styles.cardImageTextContainer, styles.cardImageNopeContainer, this.props.animatedNopeStyles]}>
                <Text style={[styles.cardImageText, styles.cardImageNopeText]}>eh</Text>
              </Animated.View>
            </Image>
...
class SwipeCards extends Component {
  ...
  getCardData() {
    fetch('https://api.shopstyle.com/api/v2/products?pid=uid7664-39148608-52&fts=red+dress&offset=0&limit=1', {
      method: 'get',
      dataType: 'json',
      headers: {
    ...
    .then((response) => 
      {
        this.state.cardData = response.json();
        console.log('HERE');
        console.log(JSON.stringify(this.state.cardData));
        return response; // << This is the problem
      })
